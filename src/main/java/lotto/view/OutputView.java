...
public class OutputView {
    ...
    public void printPrizeResult(Prizes prizes) {
        List<Prize> prizeList = prizes.getPrizes();
        System.out.println();
        System.out.println(PRIZE_RESULT_PROMPT);
        System.out.printf(THREE_PRIZE + "%n",Collections.frequency(prizeList, Prize.THREE));
        System.out.printf(FOUR_PRIZE + "%n",Collections.frequency(prizeList, Prize.FOUR));
        System.out.printf(FIVE_PRIZE + "%n",Collections.frequency(prizeList, Prize.FIVE));
        System.out.printf(BONUS_PRIZE + "%n",Collections.frequency(prizeList, Prize.FIVE_BONUS));
        System.out.printf(SIX_PRIZE + "%n",Collections.frequency(prizeList, Prize.SIX));
    }
}